import DeferredActionQueues from './deferred_action_queues';
...
Backburner.prototype = {
  ...
  setTimeout: function() {
    ...
    if (length === 0) {
      ...
      if (
        typeof methodOrArgs === 'function' ||
        (typeof methodOrArgs === 'string' && methodOrTarget !== null && methodOrArgs in methodOrTarget)
      ) {
        target = args.shift();
        method = args.shift();
      } else {
